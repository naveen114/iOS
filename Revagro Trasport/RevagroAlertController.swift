...
class RevagroAlertController: UIViewController {
    ...
    private let btnOtherColor  = UIColor.black
    private let btnCancelColor = UIColor.black
    ...
    // MARK:- DoelseAlertController Initialization
    // MARK:-
    
    /**
     Creates a instance for using DoelseAlertController
     - returns: DoelseAlertController
     */
    static func initialization() -> RevagroAlertController {
        let alertController = RevagroAlertController(nibName: "RevagroAlertController", bundle: nil)
        return alertController
    }
    
    // MARK:- DoelseAlertController Private Functions
    // MARK:-
    
    /// Inital View Setup
    private func setupDoelseAlertController() {
        ...
        if let aOkTitle = btnOkTitle {
            btnOK.setTitle(aOkTitle, for: .normal)
    ...
    private func configure(title: String, message: String, btnCancelTitle: String?, btnOtherTitle: String?, btnOkTitle: String?, titleImage: UIImage?) {
    ...
    public func showAlert(aStrTitle: String, aStrMessage: String, aCancelBtnTitle: String?, aOtherBtnTitle: String?, titleImage: UIImage, completion: alertCompletionBlock) {
        configure(title: aStrTitle, message: aStrMessage, btnCancelTitle: aCancelBtnTitle, btnOtherTitle: aOtherBtnTitle, btnOkTitle: nil, titleImage: titleImage)
        show()
        block = completion
    }
    ...
    public func showAlertWithOkButton(aStrTitle: String, aStrMessage:String, titleImage: UIImage, btnOkTitle: String, completion : alertCompletionBlock){
        configure(title: aStrTitle, message: aStrMessage, btnCancelTitle: nil, btnOtherTitle: nil, btnOkTitle: btnOkTitle, titleImage: titleImage)
        show()
        block = completion
    }
    
    public func showAlert(aStrTitle: String, aStrMessage: String, btnOkTitle: String, completion: alertCompletionBlock){
